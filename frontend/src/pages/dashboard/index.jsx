                    ...
                    <div className={styles.wrapper}>
                        ...
                        <div className={styles.createPostContainer}>
                            <img
                                ...
                                src={`${BASE_URL}/uploads/${authState.user.profilePicture}`}
                                alt="profile pic"
                            />
                            <textarea
                                ...
                                return (
                                    <div key={post._id} className={styles.singleCard}>
                                        <div className={styles.singleCard_profileContainer}>
                                            ...
                                            } className={styles.userProfile} src={`${BASE_URL}/uploads/${post.userId.profilePicture}`} alt="profile" />
                                            <div>
                                                ...
                                                {post.media && post.media !== "undefined" && (
                                                ...
                                                <div className={styles.optionsContainer}>
                                                    ...
                                                    <div onClick={async () => {
                                                        ...
                                                        <p style={{fontSize:"1rem"}}>{post.likes}</p>
                                                    </div>
                                                    {/* Comment button */}
                                                    <div onClick={() => {
                        ...
                        >
                            <div className={styles.commentsList}>
                                {(!postState.Comments || postState.Comments.length === 0) && (
                                    <h3 style={{ color: "grey", textAlign: "center", marginTop: "2rem" }}>
                                        No comments yet!
                                    </h3>
                                )}
                                ...
                                {postState.Comments.length !== 0 &&
                                    postState.Comments.map((postComment) => (
                                        <div className={styles.singleComment} key={postComment._id}>
                                            ...
                                            <p style={{ marginLeft: "3rem" }}>{postComment.body}</p>
                                        </div>
                                    ))}
                            </div>
